...
XS(XS_threads_self)
{
    dXSARGS;
    {
#line 1039 "threads.xs"
        char *classname;
        ithread *thread;
#line 1070 "threads.c"
#line 1042 "threads.xs"
        /* Class method only */
...
XS(XS_threads_tid)
{
    dXSARGS;
    {
#line 1057 "threads.xs"
        ithread *thread;
#line 1094 "threads.c"
#line 1059 "threads.xs"
...
XS(XS_threads_detach)
{
    dXSARGS;
    {
#line 1180 "threads.xs"
        ithread *thread;
        int detach_err;
        dMY_POOL;
#line 1242 "threads.c"
#line 1184 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS(XS_threads_kill)
{
    dXSARGS;
    {
#line 1228 "threads.xs"
        ithread *thread;
        char *sig_name;
        IV signal;
#line 1297 "threads.c"
#line 1232 "threads.xs"
...
XS(XS_threads_equal)
{
    dXSARGS;
    {
#line 1280 "threads.xs"
        int are_equal = 0;
#line 1360 "threads.c"
#line 1282 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS(XS_threads__handle)
{
    dXSARGS;
    {
#line 1353 "threads.xs"
        ithread *thread;
#line 1447 "threads.c"
#line 1355 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
#ifdef WIN32
...
XS(XS_threads_get_stack_size)
{
    dXSARGS;
    {
#line 1368 "threads.xs"
        IV stack_size;
        dMY_POOL;
#line 1470 "threads.c"
#line 1371 "threads.xs"
        PERL_UNUSED_VAR(items);
        if (sv_isobject(ST(0))) {
            /* $thr->get_stack_size() */
...
XS(XS_threads_set_stack_size)
{
    dXSARGS;
    {
#line 1387 "threads.xs"
        IV old_size;
        dMY_POOL;
#line 1496 "threads.c"
#line 1390 "threads.xs"
        if (items != 2) {
...
XS(XS_threads_is_running)
{
    dXSARGS;
    {
#line 1409 "threads.xs"
        ithread *thread;
#line 1524 "threads.c"
#line 1411 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS(XS_threads_is_detached)
{
    dXSARGS;
    {
#line 1426 "threads.xs"
        ithread *thread;
#line 1548 "threads.c"
#line 1428 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
        MUTEX_LOCK(&thread->mutex);
...
XS(XS_threads_is_joinable)
{
    dXSARGS;
    {
#line 1439 "threads.xs"
        ithread *thread;
#line 1568 "threads.c"
#line 1441 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS(XS_threads_wantarray)
{
    dXSARGS;
    {
#line 1458 "threads.xs"
        ithread *thread;
#line 1594 "threads.c"
#line 1460 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
...
XS(XS_threads_error)
{
    dXSARGS;
    {
#line 1489 "threads.xs"
        ithread *thread;
        SV *err = NULL;
#line 1640 "threads.c"
#line 1492 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
