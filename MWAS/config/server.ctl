...
max_cpus:15 #maximum number of cpus that can be dedicated to all MAKER jobs
...
data_dir:/home/apache/MWS/
cgi_dir:/var/www/cgi-bin/MWAS
cgi_web:/cgi-bin/MWAS #url to cgi_dir
html_dir:/var/www/html/MWAS
html_web:/MWAS #url to html_dir
