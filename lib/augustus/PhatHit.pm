...
sub nB {
        ...
        if    ($self->strand($w) == -1){
                ...
                die "dead in augustus::PhatHit::nB\n";
        }
}
#------------------------------------------------------------------------
sub nE {
        ...
        if    ($self->strand($w) == -1){
                ...
                die "dead in augustus::PhatHit::nE\n";
        }
...
sub AUTOLOAD {
        ...
        #print STDERR "augustus::PhatHit::AutoLoader called for: ",
        #      "\$self->$call","()\n";
