#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::protein2genome                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::protein2genome;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::protein2genome--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::protein2genome::AutoLoader called for: ",
        #      "\$self->$call","()\n";
