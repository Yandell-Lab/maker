#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::repeatmasker                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::repeatmasker;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::repeatmasker--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::repeatmasker::AutoLoader called for: ",
        #      "\$self->$call","()\n";
