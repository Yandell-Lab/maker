#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::trnascan                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::trnascan;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::trnascan--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::trnascan::AutoLoader called for: ",
        #      "\$self->$call","()\n";
