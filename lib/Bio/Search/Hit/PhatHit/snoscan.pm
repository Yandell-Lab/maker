#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::snoscan                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::snoscan;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::snoscan--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::snoscan::AutoLoader called for: ",
        #      "\$self->$call","()\n";
