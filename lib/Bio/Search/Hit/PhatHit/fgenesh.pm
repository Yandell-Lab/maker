#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::fgenesh                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::fgenesh;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::fgenesh--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::fgenesh::AutoLoader called for: ",
        #      "\$self->$call","()\n";
