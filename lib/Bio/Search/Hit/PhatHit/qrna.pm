...
=head1 Bio::Search::Hit::PhatHit::qrna

Bio::Search::Hit::PhatHit::qrna - The platonic ideal of a CGL module.
...
=for example_testing
  isa_ok($hit, "Bio::Search::Hit::PhatHit::qrna", "check type.");
...
package Bio::Search::Hit::PhatHit::qrna;
...
=for example_testing
  isa_ok($hit, "Bio::Search::Hit::PhatHit::blastn", "check type.");
...
sub AUTOLOAD
 {
        ...
        if($ENV{CGL_CHATTER}) {
	    print STDERR "qrna::PhatHit::AutoLoader called for: ",
	    "\$self->$call","()\n";
