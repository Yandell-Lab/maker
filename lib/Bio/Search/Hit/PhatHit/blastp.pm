...
=head1 Bio::Search::Hit::PhatHit::blastp

Bio::Search::Hit::PhatHit::blastp - The platonic ideal of a CGL module.
...
package Bio::Search::Hit::PhatHit::blastp;
