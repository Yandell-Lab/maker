#------------------------------------------------------------------------
#----           Bio::Search:HSP::PhatHSP::evm                   ---- 
#------------------------------------------------------------------------
package Bio::Search::HSP::PhatHSP::evm;
...
sub show {
	my $self = shift;
        ...
        print "--------------------------------------\n";
        print "Bio::Search:HSP::PhatHSP::evm\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search:HSP::PhatHSP::evm::AutoLoader called for: ",
        #      "\$self->$call","()\n";
