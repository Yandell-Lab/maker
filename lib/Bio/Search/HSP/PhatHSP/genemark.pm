#------------------------------------------------------------------------
#----           Bio::Search:HSP::PhatHSP::genemark                   ---- 
#------------------------------------------------------------------------
package Bio::Search::HSP::PhatHSP::genemark;
...
sub show {
	my $self = shift;
        ...
        print "--------------------------------------\n";
        print "Bio::Search:HSP::PhatHSP::genemark\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search:HSP::PhatHSP::genemark::AutoLoader called for: ",
        #      "\$self->$call","()\n";
