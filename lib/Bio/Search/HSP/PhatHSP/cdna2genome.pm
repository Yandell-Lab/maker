#------------------------------------------------------------------------
#----           Bio::Search:HSP::PhatHSP::cdna2genome                   ---- 
#------------------------------------------------------------------------
package Bio::Search::HSP::PhatHSP::cdna2genome;
...
sub show {
	my $self = shift;
        ...
        print "--------------------------------------\n";
        print "Bio::Search:HSP::PhatHSP::cdna2genome\n";
...
sub cigar_string {
	...
	"in Bio::Search:HSP::PhatHSP::cdna2genome\n".
	"for hit ".$self->name()."\n" if(@q != @h);
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search:HSP::PhatHSP::cdna2genome::AutoLoader called for: ",
        #      "\$self->$call","()\n";
