#------------------------------------------------------------------------
#----           Bio::Search:HSP::PhatHSP::trnascan                   ---- 
#------------------------------------------------------------------------
package Bio::Search::HSP::PhatHSP::trnascan;
...
sub show {
	my $self = shift;
        ...
        print "--------------------------------------\n";
        print "Bio::Search:HSP::PhatHSP::trnascan\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search:HSP::PhatHSP::trnascan::AutoLoader called for: ",
        #      "\$self->$call","()\n";
