#------------------------------------------------------------------------
#----           Bio::Search:HSP::PhatHSP::snap                   ---- 
#------------------------------------------------------------------------
package Bio::Search::HSP::PhatHSP::snap;
...
sub show {
	my $self = shift;
        ...
        print "--------------------------------------\n";
        print "Bio::Search:HSP::PhatHSP::snap\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search:HSP::PhatHSP::snap::AutoLoader called for: ",
        #      "\$self->$call","()\n";
