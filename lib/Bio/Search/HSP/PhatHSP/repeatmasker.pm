#------------------------------------------------------------------------
#----           Bio::Search:HSP::PhatHSP::repeatmasker                   ---- 
#------------------------------------------------------------------------
package Bio::Search::HSP::PhatHSP::repeatmasker;
...
sub show {
	my $self = shift;
        ...
        print "--------------------------------------\n";
        print "Bio::Search:HSP::PhatHSP::repeatmasker\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search:HSP::PhatHSP::repeatmasker::AutoLoader called for: ",
        #      "\$self->$call","()\n";
