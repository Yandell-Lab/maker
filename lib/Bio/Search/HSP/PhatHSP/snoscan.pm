#------------------------------------------------------------------------
#----           Bio::Search:HSP::PhatHSP::snoscan                   ---- 
#------------------------------------------------------------------------
package Bio::Search::HSP::PhatHSP::snoscan;
...
sub show {
	my $self = shift;
        ...
        print "--------------------------------------\n";
        print "Bio::Search:HSP::PhatHSP::snoscan\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search:HSP::PhatHSP::snoscan::AutoLoader called for: ",
        #      "\$self->$call","()\n";
