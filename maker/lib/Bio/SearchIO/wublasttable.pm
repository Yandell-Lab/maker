# $Id: wublasttable.pm,v 1.0 2008/05/08 Exp $
#
# Built by Carson Holt from blasttable.pm,v 1.10
#
# BioPerl module for Bio::SearchIO::wublasttable
#
# The module this is based on is copyrighted by Jason Stajich
#
...
Bio::SearchIO::wublasttable - Driver module for SearchIO for parsing WUBLAST -mformat 2/3 format
...
This module will support parsing WUBLAST -mformat 2 or 3 tabular output.
...
=head1 ORIGINAL MODULE AUTHOR - Jason Stajich
...
package Bio::SearchIO::wublasttable;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::SearchIO::wublasttable->new();
 Function: Builds a new Bio::SearchIO::wublasttable object 
 Returns : an instance of Bio::SearchIO::wublasttable
 Args    :
...
sub next_result{
   ...
   while( defined ($_ = $self->_readline) ) {
       ...
       my ($qname, $hname, $evalue, $n, $bits,
	   $score, $hsp_len, $identical, $positives, $mismatches,
	   $percent_id, $percent_pos, $qgapnum, $qgapslen, $sgapnum,
	   $sgapslen, $qframe, $qstart, $qend, $hframe,
	   $hstart,$hend, $hsp_group, $links) = split;

       #$percent_id, $percent_pos, $qgapnum, and $qgapnum are ignored
	   ...
	   $self->element({'Name' => 'Hit_signif',			   
			   'Data' => $evalue});
	   # we'll store the 1st hsp value as the hit score
