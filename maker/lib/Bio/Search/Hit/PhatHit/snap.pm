#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::snap                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::snap;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::snap--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::snap::AutoLoader called for: ",
        #      "\$self->$call","()\n";
