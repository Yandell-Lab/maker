#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::genemark                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::genemark;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::genemark--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::genemark::AutoLoader called for: ",
        #      "\$self->$call","()\n";
