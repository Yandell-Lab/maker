#------------------------------------------------------------------------
#----                 Bio::Search::Hit::PhatHit::est2genome                ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::est2genome;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::est2genome--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::est2genome::AutoLoader called for: ",
        #      "\$self->$call","()\n";
