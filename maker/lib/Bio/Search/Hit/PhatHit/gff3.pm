#------------------------------------------------------------------------
#----              Bio::Search::Hit::PhatHit::gff3               ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::gff3;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::gff3--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::gff3::AutoLoader called for: ",
        #      "\$self->$call","()\n";
