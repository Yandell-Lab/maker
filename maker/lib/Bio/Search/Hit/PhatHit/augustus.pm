#------------------------------------------------------------------------
#----              Bio::Search::Hit::PhatHit::augustus               ---- 
#------------------------------------------------------------------------
package Bio::Search::Hit::PhatHit::augustus;
use strict;
...
sub show {
	...
	print "---------------------------------------------------------\n";
	print "-------------io::Search::Hit::PhatHit::augustus--------------\n";
...
sub AUTOLOAD {
        ...
        #print STDERR "Bio::Search::Hit::PhatHit::augustus::AutoLoader called for: ",
        #      "\$self->$call","()\n";
